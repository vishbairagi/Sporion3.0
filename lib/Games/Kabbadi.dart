...
class Kabbadi extends StatefulWidget {
  ...
  Kabbadi({required this.isLoggedIn, required this.isAdmin});

  @override
  _KabbadiState createState() => _KabbadiState();
}

class _KabbadiState extends State<Kabbadi> {
  int teamAScore = 0;
  int teamBScore = 0;
  // int period = 1;
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    //     child: Row(
                    //       children: const [
                    //         Icon(Icons.sports, color: Colors.white, size: 14),
                    //         SizedBox(width: 4),
                    //         Text(
                    //           'mitha soni',
                    //           style: TextStyle(
